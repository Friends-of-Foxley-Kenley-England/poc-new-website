...
exports.createPages = async ({ graphql, actions, reporter }) => {
  ...
  const workDayPostTemplate = path.resolve(`./src/templates/work-day-information.js`)
...
function getPosts(result) {
      const news = result.data.allMarkdownRemark.nodes.filter(x => x.fileAbsolutePath.includes(`/content/news/`))
      const workdays = result.data.allMarkdownRemark.nodes.filter(x => x.fileAbsolutePath.includes(`work-days`))
